...
@Component({
  selector: 'videoflix-imprint-imprint',
  standalone: true,
  imports: [CommonModule],
  template: `<main class="text-white mt-20 m-5">
    <h1 class="text-2xl mb-5 text-red-700">Imprint</h1>
    ...
    <div>
      <h2 class="mb-5 mt-5">Datenschutzerklärung</h2>
      <p>
